    ...
    <div className="flex overflow-x-auto space-x-4 pr-4 py-1 bg-white sticky top-0 z-10">
      {categories.map((category, index) =>
        category ? (
          <button
            key={index}
            className="flex-shrink-0 text-sm font-semibold py-2 px-4 rounded-full shadow transition-colors duration-300 text-black bg-gray-200 hover:bg-indigo-600 hover:text-white"
